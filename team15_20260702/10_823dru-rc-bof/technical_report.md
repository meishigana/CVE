# Technical Report: CVE-XXXX-XXXX: TEW-823DRU sbin/rc NVRAM strcpy Stack Overflow
...
| CWE | CWE-121 |
| CVSS | 9.8 Critical |
| Source Material | E:\competition\漏洞\vulns\vulns\vuln-823dru-rc-stackoverflow |

## Executive Summary

The team-provided report describes a CVE-level vulnerability in TRENDnet TEW-823DRU AC3200 Router affecting sbin/rc. The issue is categorized as Stack-based Buffer Overflow / RCE and is supported by the copied PoC and evidence files in this package.
